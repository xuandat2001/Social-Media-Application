                                ...
                                <div className='col-9'>
                                    <form>
                                        <div className='search-box'>
                                            <input className="form-control input-search-header" type="search" placeholder="Search" aria-label="Search" />
                                            <button className='btn btn-search' type="button"><FontAwesomeIcon icon={faMagnifyingGlass} /></button>
                                        </div>
                                    </form>
                                </div>
                            </div> 
                    ...
                    <div className = "col-6">
                        <div className ="header-right">
                            <div className="row">
                                ...
                                <div className='col-3'>
                                    <button className="btn btn-sign-out align-items-center" type="button">Sign Out</button>
                                </div>
                            </div>
                        </div>
                    </div>
